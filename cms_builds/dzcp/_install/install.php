...
if(isset($_POST['submit'])) {
		...
		db("CREATE TABLE ".$sql_prefix."socialgameviewer_settings (
					...
					`group` varchar(100),
					`input_modul` varchar(50),
					`output_modul` varchar(50),
					PRIMARY KEY  (`id`))"); 
		...
		VALUES (
		NULL , '20', '180', '300', '".$version."', '1', '1', '1', '0', '0', '1','90245BB467E201DE99CF36C6FD1ED9FA', 'hd-gamers-de', 'steam_group', 'selfrenderimage'
		);");
